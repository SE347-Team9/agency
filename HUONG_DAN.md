# HƯỚNG DẪN AGENCY DASHBOARD

## 📋 Mô tả dự án
Agency Dashboard là hệ thống quản lý dành cho đại lý (agency), cho phép quản lý sản phẩm, đơn hàng, khách hàng và doanh thu của đại lý.
...
### 3. Chạy ứng dụng
```bash
# Chạy môi trường development (cổng 5174)
npm run dev
